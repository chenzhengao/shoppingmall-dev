...
import com.czg.pojo.UserAddress;
import com.czg.pojo.bo.AddressBO;
import com.czg.service.AddressService;
import com.czg.utils.JSONResult;
import com.czg.utils.MobileEmailUtils;
...
public class AddressController {
    ...
    public JSONResult update(@RequestBody AddressBO addressBO) {
        if (StringUtils.isBlank(addressBO.getAddressId())) {
            return JSONResult.errorMsg("修改地址错误");
        }
